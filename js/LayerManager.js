    ...
    LayerManager.prototype.synchronizeLayerList = function () {
        ...
        for (var i = 0, len = this.wwd.layers.length; i < len; i++) {
            ...
            if (layer.active) {
                ...
                if (layer.multi == 1) {
                    layerItem.addClass("side");
                }else{
                    layerItem.addClass("leftSide");
                }
                if (layer.enabled) {
    ...
    LayerManager.prototype.performSearch = function (queryString) {
        if (queryString) {
            ...
            if (queryString.match(WorldWind.WWUtil.latLonRegex)) {
                ...
                thisLayerManager.goToAnimator.goTo(new WorldWind.Position(latitude, longitude,55000));
            } else {
